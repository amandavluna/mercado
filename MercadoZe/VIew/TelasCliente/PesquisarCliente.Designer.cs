namespace MercadoZe.VIew.TelasCliente
{
    partial class PesquisarCliente
    {
        ...
        private void InitializeComponent()
        {
            ...
            label7.Location = new Point(112, 160);
            label7.Name = "label7";
            ...
            label3.Location = new Point(113, 24);
            label3.Name = "label3";
            ...
            tabPage2.TabIndex = 1;
            tabPage2.Text = "Buscar por Cliente";
            ...
            dataGridViewUsuarios.Columns.AddRange(new DataGridViewColumn[] { cod, nom, email, Cel });
